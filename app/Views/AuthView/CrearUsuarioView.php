      ...
      <div class="card-body">
        <form action="<?= base_url('sign') ?> " method="post" class="flex flex-col gap-4 justify-center items-center">
          ...
          <div class="form-group flex flex-col w-8/12 gap-2">
            ...
            <input type="email" name="email" id="email" class="form-control w-12/12 input" placeholder="Correo">
          </div>
          <div class="form-group flex flex-col w-8/12 gap-2">
          ...
          <button type="submit" class="p-2 btn bg-blue-500 text-white hover:bg-blue-400 w-8/12 rounded-4xl">Registrar</button>
        </form>
      </div>
    </div>
  </div>
